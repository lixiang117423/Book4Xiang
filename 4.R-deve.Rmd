...
```{r qPCR1, echo=FALSE, fig.cap="qPCR标曲点样示意图", fig.align = 'center', fig.width=10, fig.height=8}
knitr::include_graphics("figures/pac4xiang使用说明/1.png")
```
...
```{r qPCR2, echo=FALSE, fig.cap="函数calStandCurve返回的数据框", fig.align = 'center', fig.width=10, fig.height=8}
knitr::include_graphics("figures/pac4xiang使用说明/3.png")
```
...
```{r qPCR3, echo=FALSE, fig.cap="qPCR标曲点样示意图", fig.align = 'center', fig.width=10, fig.height=8}
knitr::include_graphics("figures/pac4xiang使用说明/2.png")
```
